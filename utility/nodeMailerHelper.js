    ...
    const emailObject = {
        ...
        html: `
         <div style="max-width: 600px; margin: 20px auto; background: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); text-align: center;">
            ...
            <a href="${verificationUrl}" style="display: inline-block; padding: 12px 24px; margin: 20px 0; text-decoration: none; color: #ffffff; background-color: #007bff; border-radius: 5px; font-size: 16px;">Verify My Email</a>
            <p style="color: #555; font-size: 16px;">If the button doesn’t work, copy and paste the following link into your browser:</p>
            <p style="word-wrap: break-word;"><a href="${verificationUrl}" target="_blank" style="color: #007bff; text-decoration: none;">${verificationUrl}</a></p>
